...
DIGIT_FONT_STYLE = ("Montserrat", 24, "bold")
...
class Calculator:
    ...
    def create_digit_buttons(self):
        for digit,grid_value in self.digits.items():
            button = tk.Button(self.buttons_frame, text=str(digit),bg=GRAY,fg=LABEL_COLOR,font=DIGIT_FONT_STYLE,
    ...
    def create_equals_button(self):
        button = tk.Button(self.buttons_frame, text="=",bg=BLUE,fg=LABEL_COLOR,font=DEFAULT_FONT_STYLE,
